...
public class GUIText {
	...
	public GUIText(String text, float fontSize, FontType font, Vector2f position, float maxLineLength,
			boolean centered, float tWidth, float tEdge, float tBorderWidth, float tBorderEdge, Vector3f tOutlineColor) {
		...
		this.borderEdge = tBorderEdge;
		this.outlineColor = tOutlineColor;
		TextMaster.loadText(this);
	}
	
	public GUIText(String text, float fontSize, FontType font, Vector2f position, float maxLineLength,
			boolean centered, float tWidth, float tEdge) {
		this.textString = text;
		this.fontSize = fontSize;
		this.font = font;
		this.position = position;
